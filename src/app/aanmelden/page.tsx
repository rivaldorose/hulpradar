...
export default function AanmeldenPage() {
  ...
  return (
    <div className="bg-background-light min-h-screen flex flex-col">
      {/* Navbar */}
      <header className="w-full max-w-[1200px] mx-auto px-6 pt-6">
        <nav className="bg-white/80 backdrop-blur-md rounded-full border border-[#e0e6db]/50 px-8 py-4 flex items-center justify-between shadow-sm">
          <Link href="/" className="flex items-center gap-2">
            <div className="text-primary">
              <HulpRadarLogo />
            </div>
            <span className="font-bold text-xl tracking-tight">HulpRadar</span>
          </Link>
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium text-[#758961] hidden sm:inline">Hulp nodig?</span>
      ...
      {/* Main Content */}
      <main className="flex-1 w-full max-w-[1200px] mx-auto px-6 py-12 lg:py-20">
